...
namespace GISTech.GISTerrainLoader
{
    public class GISTerrainLoaderRawLoader
    {
        ...
        public GISTerrainLoaderRawLoader(GISTerrainLoaderPrefs prefs)
        {
            data = new GISTerrainLoaderFileData();
            Prefs = prefs;

            m_ByteOrder = Prefs.Raw_ByteOrder;
            m_Depth = Prefs.Raw_Depth;
        }
        public void LoadFile(string filepath)
        {
            ...
            {
                if (OnReadError != null)
                    OnReadError("Error While Loading File : " + ex);
            }
