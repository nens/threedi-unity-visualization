...
{
    public class GISTerrainLoaderProjectionSystem
    {
        ...
        public GISTerrainLoaderProjectionSystem(string m_GEOGCSProjection, bool UTM=false)
        {
        ...
        public GISTerrainLoaderProjectionSystem()
        {
 
        }
        public GISTerrainLoaderProjectionSystem(int epsg, string m_GEOGCSprojection)
        {
            EPSG_Code = epsg;
            GEOGCSProjection = m_GEOGCSprojection;
        }
