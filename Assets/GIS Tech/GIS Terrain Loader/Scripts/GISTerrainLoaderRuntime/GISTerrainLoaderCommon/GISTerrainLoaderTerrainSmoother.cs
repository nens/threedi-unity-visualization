...
namespace GISTech.GISTerrainLoader
{
    public class GISTerrainLoaderTerrainSmoother
    {
        ...
        public static void SmoothTerrainHeights(List<GISTerrainTile> terrains, float m_TerrainHeightSmoothFactor)
        {
        ...
        private static float Average(GISTerrainTile terrain, int row, int col)
        {
            float avg = 0.0f;
            float total = 0.0f;
        ...
        private static bool InBounds(GISTerrainTile terrain, int row, int col)
        {
        ...
        public static void SmoothTerrainSurface(List<GISTerrainTile> terrains, int m_TerrainSurfaceSmoothFactor)
        {
        ...
        private static void smooth(GISTerrainTile terrain, Vector2 arraySize)
        {
