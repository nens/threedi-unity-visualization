...
namespace GISTech.GISTerrainLoader
{
    public class GISTerrainLoaderBlendTerrainEdge
    {
        ...
        private static GISTerrainTile[] _terrains;
        private static Dictionary<int[], GISTerrainTile> _terrainDict = null;
        ...
        public static void StitchTerrain(List<GISTerrainTile> newterrains, float m_Smoothlevel, int m_StitcheLength)
        {
            ...
            if (_terrainDict == null)
                _terrainDict = new Dictionary<int[], GISTerrainTile>(new IntArrayComparer());
            else
            {
                _terrainDict.Clear();
            }
            ...
            if (_terrains.Length > 0)
            {
                ...
                for (int i = 0; i < _terrainDict.Count; i++)
                {
                    ...
                    GISTerrainTile top = null;
                    GISTerrainTile left = null;
                    GISTerrainTile right = null;
                    GISTerrainTile bottom = null;
                ...
                for (int i = 0; i < _terrainDict.Count; i++)
                {
                    ...
                    {
                        GISTerrainTile rightBottom = null;
                        _terrainDict.TryGetValue(new int[] {
                            posTer [0] + 1,
                            posTer [1] - 1
                        }, out rightBottom);
